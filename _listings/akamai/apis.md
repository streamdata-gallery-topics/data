...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/data/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-bandwidth-cpcode-get.md
x-common:
- type: x-base
