...
- name: Akamai API Get Status Data for a Silverlight Live Stream
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-hdsll-egressstatus-streamid-get.md
x-common:
- type: x-base
