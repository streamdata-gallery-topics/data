...
- name: Akamai API Get Event&#8217;s Bandwidth Data
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-origin-bandwidth-get.md
x-common:
- type: x-base
