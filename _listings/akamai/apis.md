...
- name: Akamai API Get Entry Point Data for a Universal Live Stream
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-entrypoint-universallive-streamid-get.md
x-common:
- type: x-base
