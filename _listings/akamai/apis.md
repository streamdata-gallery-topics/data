...
- name: Akamai API Get Event&#8217;s Origin Statuses per CP Code
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-origin-status-cpcode-get.md
x-common:
- type: x-base
