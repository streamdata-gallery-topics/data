...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-requests-get.md
x-common:
- type: x-base
