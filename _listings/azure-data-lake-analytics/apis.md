...
- name: Azure Data Lake Analytics API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/data/master/_listings/azure-data-lake-analytics/catalog-usql-databases-databasename-tables-get.md
x-common:
