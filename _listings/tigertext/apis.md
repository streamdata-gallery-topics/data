...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/tigertext/apis.md
...
- name: Tiger Connect Metadata API Clears the metadata for a User or Group based on
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/tigertext/metadatagroup-token-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/tigertext/metadatagroup-token-delete-openapi.md
- name: Tiger Connect Metadata API Get the metadata for a User or Group based on address
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/tigertext/metadatagroup-token-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/tigertext/metadatagroup-token-get-openapi.md
- name: Tiger Connect Metadata API Adds metadata for a User or Group based on address
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/tigertext/metadatagroup-token-post-openapi.md
- name: Tiger Connect Metadata API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/tigertext/openapi.md
x-common:
- type: x-android-sdk
