...
- name: Box Get Metadata Template
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/box/metadata-templates-scope-template-schema-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/box/metadata-templates-scope-template-schema-get-postman.md
x-common:
- type: x-base
