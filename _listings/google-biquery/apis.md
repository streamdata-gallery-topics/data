...
- name: Google BigQuery API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/data/master/_listings/google-biquery/projects-projectid-datasets-datasetid-tables-tableid-data-get.md
x-common:
- type: x-code
