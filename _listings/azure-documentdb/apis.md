...
- name: Azure DocumentDB API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/data/master/_listings/azure-documentdb/subscriptions-subscriptionid-providers-microsoft-documentdb-databaseaccounts-get.md
x-common:
