...
- name: Google Cloud SQL API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/data/master/_listings/google-cloud-sql/projects-project-instances-instance-databases-database-get.md
x-common:
- type: x-change-log
