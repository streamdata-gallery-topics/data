...
- name: Google Cloud SQL API Get Projects Project Instances Instance Databases Database
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/google-cloud-sql/projects-project-instances-instance-databases-database-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/google-cloud-sql/projects-project-instances-instance-databases-database-get-postman.md
x-common:
- type: x-change-log
