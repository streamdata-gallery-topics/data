...
- name: Xignite Statistics
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/xignite/getannualizedtopicdata-post.md
- name: Xignite Statistics Get Latest Topic Data
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/xignite/getlatesttopicdata-post.md
x-common:
- type: x-net-sdk
