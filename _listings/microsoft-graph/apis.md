...
- name: Microsoft Graph API Table Data Body Range
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/microsoft-graph/workbook-tables(-lt;id|name-gt;)-databodyrange-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data/master/_listings/microsoft-graph/workbook-tables(-lt;id|name-gt;)-databodyrange-post-postman.md
x-common:
- type: x-change-loge
